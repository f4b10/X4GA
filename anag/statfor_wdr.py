...
#-----------------------------------------------------------------------------
# Python source generated by wxDesigner from file: statfor.wdr
...
def StatForCardFunc( parent, call_fit = True, set_sizer = True ):
    ...
    item4 = UnoZeroCheckBox( parent, ID_HIDESEARCH, "Nascondi nelle ricerche i fornitori con questo status", wx.DefaultPosition, wx.DefaultSize, 0 )
    ...
    item6 = wx.StaticBox( parent, -1, "Non consentire l'uso dei fornitori con questo stato:" )
    item5 = wx.StaticBoxSizer( item6, wx.VERTICAL )
    
    item7 = UnoZeroCheckBox( parent, ID_NOMOV_ORDFOR, "Nei documenti di tipo ordine", wx.DefaultPosition, wx.DefaultSize, 0 )
    item7.SetName( "nomov_ordfor" )
    item5.Add( item7, 0, wx.GROW|wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )

    item8 = UnoZeroCheckBox( parent, ID_NOMOV_CARFOR, "Nei documenti di carico", wx.DefaultPosition, wx.DefaultSize, 0 )
    item8.SetName( "nomov_carfor" )
    item5.Add( item8, 0, wx.GROW|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT|wx.BOTTOM, 5 )

    item9 = UnoZeroCheckBox( parent, ID_NOMOV_RESFOR, "Nei documenti reso", wx.DefaultPosition, wx.DefaultSize, 0 )
