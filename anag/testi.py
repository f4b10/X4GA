...
FRAME_TITLE = "Testi Richiamabili"


class TestiPanel(ga.AnagPanel):
    def __init__(self, *args, **kwargs):
        ga.AnagPanel.__init__(self, *args, **kwargs)
        self.SetDbSetup( bt.tabelle[ bt.TABSETUP_TABLE_TESTI] )
        self.db_report = None
        #self.db_report = "Testi Richiamabili"

    def InitAnagCard(self, parent):
        p = wx.Panel( parent, -1)
        wdr.TestiFunc( p, True )
        return p
...
class TestiFrame(ga._AnagFrame):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.LoadAnagPanel(TestiPanel(self, -1))


# ------------------------------------------------------------------------------


class TestiDialog(ga._AnagDialog):
    """
