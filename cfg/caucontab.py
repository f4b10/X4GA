...
class CauContabSearchResultsGrid(ga.SearchResultsGrid):
    ...
    def GetDbColumns(self):
        ...
        return (( 35, (cn('cfgcontab_codice'),   "Cod.",          _STR, True)),
                ...
                ( 60, (cn('cfgcontab_trx_tdoc'), "Tipo Doc.",     _STR, True)),
                ( 40, (cn('cfgcontab_trx_flag'), "Trasm.",        _CHK, True)),
                (100, (cn('cfgcontab_pralcf'),   "Segno Spes.",   _STR, True)),
...
class CauContabPanel(ga.AnagPanel):
    ...
    def InitAnagCard(self, parent):
        ...
        for name, val in (("regivadyn", (0,1)),
                          ...
                          ("trx_flag",  {True:   1, False:   0}),
                          ):
            cn(name).SetDataLink(name, val)

        cn('trx_flag').Bind(wx.EVT_CHECKBOX, self.OnTrasmitChanged)
        ...
        cn('trx_tdoc').SetDataLink('trx_tdoc', ('', 'TD01', 'TD02', 'TD03', 'TD04', 'TD05', 'TD06', 'TD07', 'TD08', 'TD09', 'TD10', 'TD11', 'TD12'))
        return p
    ...
    def OnTrasmitChanged(self, event):
        ...
        self.FindWindowByName('trx_tdoc').Enable(obj.GetValue()==1)
        event.Skip()
    ...
    def UpdateDataControls( self, recno ):
        ...
        self.FindWindowByName('trx_tdoc').Enable(self.FindWindowByName('trx_flag').GetValue()==1)
