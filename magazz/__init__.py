...
RSMOV_IMPORTO =  15; a('importo')
RSMOV_ID_IVA  =  16; a('id_aliqiva')
RSMOV_NOTE    =  17; a('note')
RSMOV_ACQMOV  =  18; a('id_moveva')
RSMOV_ACCMOV  =  19; a('id_movacc')
RSMOV_PERPRO  =  20; a('perpro')
