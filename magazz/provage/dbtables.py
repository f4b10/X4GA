...
class ProvvigAgentiDetTable(adb.DbTable):
    ...
    def __init__(self):
        ...
        self.AddAverageOf('mov.importo*tipdoc.provvig', 'vendita')
        ...
        self.AddAverageOf('mov.importo*IF(mov.perpro IS NULL, prod.perpro, mov.perpro)*(tipdoc.provvig)/100', 'provvig')
