...
def CheckViesFunc( parent, call_fit = True, set_sizer = True ):
    ...
    item0.Add( item5, 0, wx.GROW|wx.ALIGN_CENTER_VERTICAL|wx.BOTTOM, 5 )

    item6 = wx.StaticText( parent, ID_TEXT, 
        "Maggiori dettagli disponibili sulla\n"
        "pagina web dell'Agenzia Entrate.",
        wx.DefaultPosition, wx.DefaultSize, 0 )
    item0.Add( item6, 0, wx.ALIGN_CENTER|wx.LEFT|wx.RIGHT|wx.BOTTOM, 5 )

    item7 = wx.FlexGridSizer( 0, 2, 0, 0 )
    
    item8 = wx.Button( parent, ID_BTNWEB, "Apri pagina WEB", wx.DefaultPosition, wx.DefaultSize, wx.NO_BORDER )
    item8.SetName( "btnweb" )
    item7.Add( item8, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.BOTTOM, 5 )

    item9 = wx.Button( parent, ID_BTNQUIT, "Chiudi", wx.DefaultPosition, wx.DefaultSize, 0 )
    item9.SetName( "btnquit" )
    item7.Add( item9, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.BOTTOM, 5 )
