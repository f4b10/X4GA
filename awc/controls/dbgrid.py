...
from mx.DateTime import FORMAT_DATE, FORMAT_DATE_SH, FORMAT_DATETIME, FORMAT_DATETIME_SH
    ...
    def _MultiParam(self, param, classAttr):
        ...
        if type(param) in (list, tuple):
            for n in range(len(param)):
                if isinstance(param[n], classAttr):
